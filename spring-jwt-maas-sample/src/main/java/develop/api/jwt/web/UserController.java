...
import develop.api.jwt.domain.AcceptInvitation;
import develop.api.jwt.domain.InvitationNotFoundException;
...
import static develop.api.jwt.user.UserRepository.passwordEncoder;
...
public class UserController {
  ...
  public String token(Authentication authentication) {
	  String result = ((JwtAuthenticationToken) authentication).getToken();
    return result;
  }
